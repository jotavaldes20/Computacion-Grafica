...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[filename pathname] = uigetfile({'*.jpg','*.png'},'File Selector'); % Buscar imagen de forma grÃ¡fica
...
if estado2==1
    switch opcion
        ...
        case 2 
            ...
            imagesc(handles.Ifiltrada, 'Parent', handles.Imagen3),title('Erosión');
            axis off; %desabilitar ejes coordenados
        case 3 
            %Erosion Color
            %Creamos elemento Estructurante
...
set(handles.Menu2,'String',{'Cartoon','Erosión','Dilatación','Filtro Bilateral'});%filtros para imagen a color
% imagen en color
handles.Ioriginal=(handles.I);
...
msgbox({'Computación Grafica 2017','Integrantes:', '    Jorge Valdes','    Ignacio Monjes', '    Jorge Urra', 'Ingenieria Civil Informatica'}, 'Información','info');
